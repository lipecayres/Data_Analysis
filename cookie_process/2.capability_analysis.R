...
# Comments:
# Specification limits: Lower: 0.10 | Upper 0.17
# Target: 0.136
...
cp <- ss.ca.cp(weight_loss,0.10, 0.17)
print(cp)

#Calculo do Cpk
cpk <- ss.ca.cpk(weight_loss,0.10, 0.17)
print(cpk)

#Estudo SixSigma do Cp e Cpk
ss.study.ca(weight_loss, weight_loss, LSL = 0.10, USL = 0.17,
            Target = 0.136, alpha = 0.5,
            f.su = "Weight loss fraction")
